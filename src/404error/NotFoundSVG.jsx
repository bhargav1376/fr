...
import "./NotFoundSVG.css";
function NotFoundSVG({ countdown, navigate }) {
  return (
     <div class="wrapper-svg"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-250 0 2500 1080">
...
<div className="error-p"> <p className="not-found" >Page Not Found</p> <p className="redirect-page" >Redirecting to Home Page in <br></br> <b>{countdown}</b> seconds...</p> <button className="btn-neon-404" onClick={() => navigate("/")}>Go Home</button> </div> </div>
  );
}
